...
public class TokenGenerator {
    ...
    /**
     * Taken from https://github.com/defuse/password-hashing/blob/master/PasswordStorage.java
     */
    public static class PasswordStorage
    {
        ...
        @Inject
        public PasswordStorage(Configuration conf) {
            this.secret = conf.getString("play.crypto.secret");
        }
        ...
        public String createHash(char[] password)
                throws CannotPerformOperationException
        {
            /* We need always the same salt so the same hashed password generates the same string!
